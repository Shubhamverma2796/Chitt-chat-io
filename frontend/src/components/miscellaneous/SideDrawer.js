import { Button, Tooltip, Box, Text, Menu, MenuButton, MenuList, Avatar, MenuItem, MenuDivider, useToast, Spinner } from '@chakra-ui/react'
      ...
      >
        ...
        >
          <Button variant="ghost" onClick={onOpen}>
            ...
            <Text d={{ base: "none", mid: "flex" }} px='4'>
              Search User
            </Text>
          </Button>
        </Tooltip>
